...
export function SadIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={classNames('h-6 w-6', className)} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function GithubIcon({ className }: IconProps) {
  return (
    <svg role="img" className={classNames('h-6 w-6', className)} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <title>GitHub</title>
